import {dragDropIjs, dragDropGeld, reloadSpeech, hintGlow} from "./functions2.js";
...
const herhaalIjs = document.getElementById("js--speech-reload--ijs"); 
...
herhaalIntro.onclick = () => {
    reloadSpeech(goedemiddag, herhaalIntro);
}

herhaalIjs.onclick = () => {
    reloadSpeech(bolletjes, herhaalIjs);
}
